...
auth_channel = environ.get('AUTH_CHANNEL', '-1002368300299') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://theatrebot007:theatrepun@cluster0.erdf64v.mongodb.net/?retryWrites=true&w=majority")
